      ...
      return (
        <div className="overflow-hidden">
          <div
            ...
            className="min-h-screen flex flex-col items-center justify-center text-center px-4 bg-bg"
          >
            ...
            <h1
              ref={this.h1Ref}
              className="text-4xl md:text-5xl font-bold mb-4 text-main"
            >
            ...
            {process.env.NODE_ENV === "development" && this.state.error && (
              <details className="mt-8 text-left max-w-2xl">
                <summary className="cursor-pointer font-semibold mb-2 text-sec">
