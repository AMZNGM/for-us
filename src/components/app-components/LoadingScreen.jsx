...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    // Auto-hide after animation completes (4 seconds - 3s path + 1s fill)
          ...
          <div className="relative w-54 h-54 max-md:w-34 max-md:h-34 flex flex-col justify-center items-center">
            ...
            >
              <motion.path
                ...
                onAnimationComplete={() => {
                  // This will trigger the exit animation after the path is drawn
                  setTimeout(() => {
                    setIsLoading(false);
                  }, 1000); // Wait for the fill animation to complete
                }}
              />
              <motion.path
